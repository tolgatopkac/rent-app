    ...
    Footer() {
      ...
      return (
        <View className="text-center mt-4">
          <p className="">Don&apos; have an account? </p>
          <button onClick={toSignUp} className="border-none bg-transparent">
            Sign Up
          </button>
        </View>
      );
    ...
    Footer() {
      ...
      return (
        <View className="text-center mt-4">
          ...
          <button onClick={toSignIn} className="border-none bg-transparent">
            Sign In
          </button>
        </View>
      );
...
const Auth = ({ children }: { children: React.ReactNode }) => {
  ...
  // Redirect to authenticated users away from auth pages
  useEffect(() => {
    if (user && isAuthPage) {
      router.push("/");
    }
